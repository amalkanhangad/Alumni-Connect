      ...
      <Container>
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Box sx={{ position: 'relative', paddingTop: '96px' }}>
              <Image src="/images/about.jpg" width={650} height={478} quality={97} alt="about img" style={{ borderRadius: '12px' }}/>
            </Box>
          </Grid>
          <Grid item xs={12} md={7}>
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              We work to connect NASC alumni with the college and each other in mutually beneficial ways. The Alumni
              Association was founded in XXXX "to promote the interests of the college and the friendly intercourse of
              its graduates."
            </Typography>
